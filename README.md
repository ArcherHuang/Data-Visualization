...
* 感測資料收集與資料視覺化實作範例
  ...
  * 3、Grafana
    ...
    * [3.3 在 AWS EC2 安裝 Ubuntu]()
        * [2.4 macOS 登入 AWS EC2 教學](https://oranwind.org/-aws-macos-deng-ru-aws-ec2-jiao-xue/)
    * 3.4 Windows 登入 AWS EC2 教學
       * [將 AWS EC2 的 .pem 檔轉換為 .ppk 檔教學](https://oranwind.org/-aws-jiang-aws-ec2-de-pem-dang-zhuan-huan-wei-ppk-dang-jiao-xue/)
       * [Windows 登入 AWS EC2 教學](https://oranwind.org/-aws-windows-deng-ru-aws-ec2-jiao-xue/)
    * [3.5 在 AWS EC2 安裝 Mosquitto](https://oranwind.org/-edge-zai-ubuntu-an-zhuang-mosquitto-mqtt-broker-part-2/)
    * [3.6 MQTTlens 串接 Mosquitto]()
    * [3.7 在 AWS EC2 安裝 Node-RED]()
    * [3.8 Node-RED 設定串接 Mosquitto]()
    * [3.9 在 AWS EC2 安裝 InfluxDB]()
    * [3.10 在 AWS EC2 安裝 Grafana]()
    * [3.11 Node-RED 串接 InfluxDB]()
    * [3.12 Grafana 串接 InfluxDB]()
    * [3.13 設備端串接 Mosquitto]()
